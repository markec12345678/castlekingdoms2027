...
3. **Overlay opacity slider v panel** — vizualni slider v Ctrl+U panelu za nastavitev opacity
4. **Overlay settings consolidation** — združitev position/opacity/hidden v eno datoteko

## ZAKLJUČENE NADGRADNJE (v3.11.382 - v3.11.930)
