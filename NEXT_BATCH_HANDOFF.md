...
- Tech Tree: **168 deps · 45 verig · 78 multi-prereq** (10x zažetnih 8!)
...
## ZAKLJUČENE NADGRADNJE (v3.11.382 - v3.11.987)
...
5. **Kirurgija+ chain 2** — dodatni kirurški deps (npr. BoneSawMaker → Metalwork + GemMiner za rezilo)
6. **Astrologija+ chain 2** — dodatni astronomski deps (npr. Telescope → GlassBench + Metalwork za tube)
