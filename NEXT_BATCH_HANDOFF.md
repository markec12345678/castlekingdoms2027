...
5. **Market Dashboard product hover tooltip** — hover na produkt prikaže podrobnosti (cena, trend, vir) v tooltip box
6. **Tech tree multi-select persistence** — shranjevanje multi-izbire med sejami
