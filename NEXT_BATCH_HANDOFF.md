...
4. **Save leaderboard mode** — persistenca leaderboardMode in sortMode je vključena, dodaj še autoSellEnabled in autoSellInterval

## ZAKLJUČENE NADGRADNJE (v3.11.382 - v3.11.912)
