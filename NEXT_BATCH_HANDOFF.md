...
5. **Tech tree depth-based sorting** — sort verig po globini (plitev→globok) namesto abecedno
6. **Tech tree node hover preview** — hover na vozlišče prikaže preview graf povezanih sistemov v tooltip box
