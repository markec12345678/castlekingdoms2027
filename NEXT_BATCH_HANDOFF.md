...
## TRENUTNO STANJE
- Različica: **v3.13.13** (60 animation frames + full sync)
- Tags: v3.12.171-beta, v3.12.184-tier1-complete, v3.12.205-tier2-complete, v3.12.211-hd-terrain-complete, v3.13.0-rc1, v3.13.0, v3.13.4, v3.13.10
- .love paket: **castlekingdoms2027-v3.13.10.love (137 MB, 1675 Lua, 1992 PNG)**
- Skupaj PNG assets: **304 pravih** (50 T1 + 100 T2 + 12 terrain + 50 buildings + 20 units + 22 UI + 2 art + 60 animations)
...
## ZAKLJUČENE NADGRADNJE (v3.11.382 - v3.12.141)

- ✅ **v3.12.141**: Load State Restoration — obnovitev težavnosti + hitrosti + dosežkov ob loadu! State.lua deserialize() razširjen z 4 restoration hook-i: (1) DifficultySettings.set(load.difficulty) obnovi težavnost, (2) combat stats logiranje (informational), (3) AchievementTracker.import(load.achievementProgress) obnovi vse dosežke in progress, (4) GameSpeedControl.setSpeed(load.gameSpeedIndex) obnovi hitrost igre. Vsi hook-i wrappani v if load.X and _G.X then za backward compatibility + pcall za crash zaščito. Debug print za vsak restoration. Save/Load je sedaj popoln cikel — save shrani, load obnovi.
