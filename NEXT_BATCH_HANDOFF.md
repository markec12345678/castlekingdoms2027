...
3. **Overlay opacity control** — igralec lahko nastavi prosojnost overlay-a
4. **Overlay hide/show toggle** — shortcut za skrivanje overlay-a brez izklopa auto-save

## ZAKLJUČENE NADGRADNJE (v3.11.382 - v3.11.927)
