...
[![Version](https://img.shields.io/badge/version-3.11.998-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
- **Zadnja izdaja**: [v3.11.998](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.998.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 990 Royal sistemov, 1648 Lua datotek, +FOUNDRY ACCESSORIES+ 3 CHAIN (Sand/Mold/Core+ 2: 6 novih deps: SandMold, MoldDryingOven, MoldCoatingBrush, CoreOven, CorePasteMixer, MoldClamp; 5 multi-prereq; 3 CROSS-CHAIN povezave: MasonStonecutter←Kamnoseštvo+, GlassBench←Steklarstvo+ x2, PigmentGrinderMaker←Barvila+; 228→234 deps, 55→56 verig, 128→133 multi-prereq; MEJNIK 56 verig in 133 multi-prereq = 16.625x začetnih 8!) + GLASS FORMING TOOLS+ + GLASS BATCH+ + FOUNDRY ACCESSORIES+ 2 + GLASS KILN+ + GLASS COLORANT+ + GLASS ANNEALING+ + GLASS ENGRAVING+ + MILLING+ + GARDEN+ 2 + ANVIL+ + ARMOR/WEAPON+ + MINING+ + CLOCKMAKING+ + KITCHEN+ + DYE/PIGMENT+ + MASONRY+ + BREWING/BAKING+ + FISHING+ + CANDLE/WAX+ + MUSICAL INSTRUMENTS+ + POTTERY+ + TEXTILE+ + BOOKBINDING+ + FOUNDRY+ + GLASSMAKING+ + ASTRONOMY+ + SURGICAL+ + TECH TREE IV + HOVER TOOLTIP EKOSISTEM + CUSTOM PRESET CRUD + MULTI-SELECT PERSISTENCE + CONFIG PRESETS + EXPORT/IMPORT + 100% mouse/wheel + overlay + DynamicMarket + Save/Load + 7 grafov
