...
[![Version](https://img.shields.io/badge/version-3.11.921-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
- **Zadnja izdaja**: [v3.11.921](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.921.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1642 Lua datotek, +RoyalSystemsRegistry + Ctrl+R UI Panel (wheel scroll + scrollbar + Home/End/PgUp/PgDn) + Ctrl+K Market Dashboard + Ctrl+U Auto-Save Panel + DynamicMarket integracija + Save/Load + 7 grafov
