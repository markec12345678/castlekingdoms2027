...
[![Version](https://img.shields.io/badge/version-3.11.916-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
[![Registry](https://img.shields.io/badge/Royal%20Registry-%2BEventLogPanel-blueviolet.svg)](#)

## Prenosi

- **Zadnja izdaja**: [v3.11.916](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.916.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1641 Lua datotek, +RoyalSystemsRegistry + Ctrl+R UI Panel + DynamicMarket integracija + Save/Load (Royal + Market Dashboard + auto-sell + market state + versioning) + Ctrl+K Market Dashboard + 7 grafov + expandable event log panel
...
| **Royal Market Dashboard** | **Ctrl+K (987 produktov + 7 grafov + leaderboard (qty/profit) + multi-product comparison + event log + EXPANDABLE event log panel z filtri)** |
