...
[![Version](https://img.shields.io/badge/version-3.11.928-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
[![Registry](https://img.shields.io/badge/Royal%20Registry-%2BOverlayHide-blueviolet.svg)](#)

## Prenosi

- **Zadnja izdaja**: [v3.11.928](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.928.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1643 Lua datotek, +RoyalSystemsRegistry + Ctrl+R UI Panel + Ctrl+K Market Dashboard + Ctrl+U Auto-Save Panel + Shift+U quick toggle + Ctrl+Shift+U overlay hide/show + auto-save HUD overlay (drag-to-move, persisted, reset, hide) + F1 keybind help (scrollable) + DynamicMarket integracija + Save/Load + 7 grafov
...
| **Royal Auto-Save Overlay** | **always-on HUD (status, timer, progress, drag-to-move, hide/show z Ctrl+Shift+U)** |
