...
[![Version](https://img.shields.io/badge/version-3.11.929-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
- **Zadnja izdaja**: [v3.11.929](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.929.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1643 Lua datotek, +RoyalSystemsRegistry + Ctrl+R UI Panel + Ctrl+K Market Dashboard + Ctrl+U Auto-Save Panel + Shift+U quick toggle + Ctrl+Shift+U overlay hide + auto-save HUD overlay (drag-to-move, persisted, reset, hide, OPACITY control z wheel) + F1 keybind help (scrollable) + DynamicMarket + Save/Load + 7 grafov
...
| **Royal Auto-Save Overlay** | **always-on HUD (status, timer, progress, drag-to-move, hide/show, OPACITY z wheel, persisted)** |
