...
[![Version](https://img.shields.io/badge/version-3.11.924-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
[![Registry](https://img.shields.io/badge/Royal%20Registry-%2BAutoSaveOverlay-blueviolet.svg)](#)

## Prenosi

- **Zadnja izdaja**: [v3.11.924](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.924.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1643 Lua datotek, +RoyalSystemsRegistry + Ctrl+R UI Panel + Ctrl+K Market Dashboard + Ctrl+U Auto-Save Panel + Shift+U quick toggle + auto-save HUD overlay (always-on) + F1 keybind help + DynamicMarket integracija + Save/Load + 7 grafov
...
| **Royal Auto-Save Overlay** | **always-on HUD (status, timer, mini progress bar, click za panel)** |
