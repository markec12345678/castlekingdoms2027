...
[![Version](https://img.shields.io/badge/version-3.11.990-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
- **Zadnja izdaja**: [v3.11.990](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.990.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 990 Royal sistemov, 1648 Lua datotek, +MILLING+ CHAIN (6 novih deps: Millstone, MillstoneSpindleBearing, MillHopperShaker, GrainHopper, MillHopperSightGlass, MillstoneDresser; 5 multi-prereq; 3 CROSS-CHAIN povezave: SpinningWheel←Tekstil+, GlassBench←Steklarstvo+, Metalwork←Kovastvo+; 180→186 deps, 47→48 verig, 88→93 multi-prereq; MEJNIK 186 deps, 48 verig, 93 multi-prereq = 11.6x začetnih 8!) + GARDEN+ 2 + ANVIL+ + ARMOR/WEAPON+ + MINING+ + CLOCKMAKING+ + KITCHEN+ + DYE/PIGMENT+ + MASONRY+ + BREWING/BAKING+ + FISHING+ + CANDLE/WAX+ + MUSICAL INSTRUMENTS+ + POTTERY+ + TEXTILE+ + BOOKBINDING+ + FOUNDRY+ + GLASSMAKING+ + ASTRONOMY+ + SURGICAL+ + TECH TREE IV + HOVER TOOLTIP EKOSISTEM + CUSTOM PRESET CRUD + MULTI-SELECT PERSISTENCE + CONFIG PRESETS + EXPORT/IMPORT + 100% mouse/wheel + overlay + DynamicMarket + Save/Load + 7 grafov
