...
[![Version](https://img.shields.io/badge/version-3.11.958-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
- **Zadnja izdaja**: [v3.11.958](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.958.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1645 Lua datotek, +TECH TREE KEYBOARD NAVIGATION (Tab/Shift+Tab za navigacijo med vozlišči, auto-scroll) + MINIMAP DRAG + PROGRESS BAR + STATS SUMMARY + STATE FILTER + DEPTH-BASED SORTING + ARROWS + DEPTH INDICATOR + MINIMAP + CLICK-TO-JUMP + PATH HIGHLIGHT + SEARCH/FILTER + CLICK-TO-FOCUS + GRAF z bezier krivuljami + hover tooltip + 65 deps v 25 verigah + 100% mouse/wheel + overlay + DynamicMarket + Save/Load + 7 grafov
