...
[![Version](https://img.shields.io/badge/version-3.11.918-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
[![License](https://img.shields.io/badge/license-Apache%202.0-green.svg)](LICENSE)
[![LÖVE](https://img.shields.io/badge/LÖVE-11.5-orange.svg)](https://love2d.org)
[![Syntax](https://img.shields.io/badge/syntax-1642%2F1642%20pass-brightgreen.svg)](#)
[![Systems](https://img.shields.io/badge/Royal%20systems-987-blue.svg)](#)
[![Lua](https://img.shields.io/badge/Lua%20files-1642-green.svg)](#)
[![Registry](https://img.shields.io/badge/Royal%20Registry-%2BAutoSavePanel-blueviolet.svg)](#)

## Prenosi

- **Zadnja izdaja**: [v3.11.918](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.918.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1642 Lua datotek, +RoyalSystemsRegistry + Ctrl+R UI Panel + Ctrl+K Market Dashboard + Ctrl+U Auto-Save Panel + DynamicMarket integracija + Save/Load + 7 grafov + expandable event log panel
...
| GLSL shaderji | 12 |
| Jezikov | 32 |
| Verzij | 140+ (v1.7.9 → v3.11.918) |
| Bug popravkov | 155 (90 krogov pregleda) |
| Syntax pass rate | 1642/1642 (100%) |
| PNG assetov | 1.206 |
| **Royal sistemov** | **987 (v3.11.918)** |
