...
[![Version](https://img.shields.io/badge/version-3.11.942-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
- **Zadnja izdaja**: [v3.11.942](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.942.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1645 Lua datotek, +100% mouse (6×4) + 100% wheel (6×4) + tech tree 46 deps + overlay + DynamicMarket + Save/Load + 7 grafov
