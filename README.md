...
[![Version](https://img.shields.io/badge/version-3.11.905-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
[![Registry](https://img.shields.io/badge/Royal%20Registry-%2BPriceChart%2BProdChart-blueviolet.svg)](#)

## Prenosi

- **Zadnja izdaja**: [v3.11.905](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.905.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1640 Lua datotek, +RoyalSystemsRegistry + Ctrl+R UI Panel + DynamicMarket integracija + Save/Load + Ctrl+K Market Dashboard + price history chart + production chart
...
| **Royal Market Dashboard** | **Ctrl+K (pregled vseh 987 produktov, cene, trendi, volumi, price history chart)** |
