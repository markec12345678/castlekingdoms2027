...
[![Version](https://img.shields.io/badge/version-3.11.978-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
- **Zadnja izdaja**: [v3.11.978](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.978.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 990 Royal sistemov, 1648 Lua datotek, +MUSICAL INSTRUMENTS+ CHAIN (6 novih deps: Harp, Lute, OrganPipe, Bagpipe, Cymbal, Shawm; 108→114 deps, 35→36 verig, 33→39 multi-prereq) + POTTERY+ + TEXTILE+ + BOOKBINDING+ + FOUNDRY+ + GLASSMAKING+ + ASTRONOMY+ + SURGICAL+ + TECH TREE IV + HOVER TOOLTIP EKOSISTEM + CUSTOM PRESET CRUD + MULTI-SELECT PERSISTENCE + CONFIG PRESETS + EXPORT/IMPORT + CLICK-TO-JUMP + BOOKMARKS + KEYBOARD NAVIGATION + MINIMAP DRAG + PROGRESS BAR + STATS SUMMARY + 100% mouse/wheel + overlay + DynamicMarket + Save/Load + 7 grafov
