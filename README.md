...
[![Version](https://img.shields.io/badge/version-3.11.997-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
- **Zadnja izdaja**: [v3.11.997](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.997.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 990 Royal sistemov, 1648 Lua datotek, +GLASS FORMING TOOLS+ CHAIN (6 novih deps: GlassMarver, GlassPuntyRod, GlassGatheringIron, GlassShears, GlassYoke, GlassLehrBelt; 5 multi-prereq; 3 CROSS-CHAIN povezave: MasonStonecutter←Kamnoseštvo+, Metalwork←Kovastvo+ x5, WoodLathe←Woodworking+ x4; 222→228 deps, 54→55 verig, 123→128 multi-prereq; MEJNIK 128 multi-prereq = 16x začetnih 8!) + GLASS BATCH+ + FOUNDRY ACCESSORIES+ 2 + GLASS KILN+ + GLASS COLORANT+ + GLASS ANNEALING+ + GLASS ENGRAVING+ + MILLING+ + GARDEN+ 2 + ANVIL+ + ARMOR/WEAPON+ + MINING+ + CLOCKMAKING+ + KITCHEN+ + DYE/PIGMENT+ + MASONRY+ + BREWING/BAKING+ + FISHING+ + CANDLE/WAX+ + MUSICAL INSTRUMENTS+ + POTTERY+ + TEXTILE+ + BOOKBINDING+ + FOUNDRY+ + GLASSMAKING+ + ASTRONOMY+ + SURGICAL+ + TECH TREE IV + HOVER TOOLTIP EKOSISTEM + CUSTOM PRESET CRUD + MULTI-SELECT PERSISTENCE + CONFIG PRESETS + EXPORT/IMPORT + 100% mouse/wheel + overlay + DynamicMarket + Save/Load + 7 grafov
