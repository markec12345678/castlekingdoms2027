...
[![Version](https://img.shields.io/badge/version-3.11.927-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
[![Registry](https://img.shields.io/badge/Royal%20Registry-%2BOverlayDrag-blueviolet.svg)](#)

## Prenosi

- **Zadnja izdaja**: [v3.11.927](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.927.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1643 Lua datotek, +RoyalSystemsRegistry + Ctrl+R UI Panel + Ctrl+K Market Dashboard + Ctrl+U Auto-Save Panel + Shift+U quick toggle + auto-save HUD overlay (drag-to-move, persisted, reset) + F1 keybind help (scrollable z 50+ entry-ji) + DynamicMarket integracija + Save/Load + 7 grafov
