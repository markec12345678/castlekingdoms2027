...
[![Version](https://img.shields.io/badge/version-3.11.939-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
- **Zadnja izdaja**: [v3.11.939](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.939.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 987 Royal sistemov, 1645 Lua datotek, +POPOLN mouse forwarding za vseh 6 panelov (100%) + tech tree + system dependencies + overlay + DynamicMarket + Save/Load + 7 grafov
