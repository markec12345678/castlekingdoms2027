...
[![Version](https://img.shields.io/badge/version-3.11.992-blue.svg)](https://github.com/markec12345678/castlekingdoms2027/releases)
...
- **Zadnja izdaja**: [v3.11.992](https://github.com/markec12345678/castlekingdoms2027/releases)
- **.love datoteka**: `castlekingdoms2027-v3.11.992.love` (34 MB brez LFS, 305 MB z LFS)
- **Changelog**: [CHANGELOG.md](CHANGELOG.md) — 990 Royal sistemov, 1648 Lua datotek, +GLASS ANNEALING+ CHAIN (6 novih deps: GlassAnnealingOven, GlassAnnealingOvenThermocouple, GlassAnnealingOvenInspectionMirror, GlassAnnealingRoller, GlassAnnealingCart, GlassAnnealingFork; 5 multi-prereq; 3 CROSS-CHAIN povezave: ForgeTuyere←Livarstvo+, GlassBench←Steklarstvo+ x2; 192→198 deps, 49→50 verig, 98→103 multi-prereq; MEJNIK 50 verig in 103 multi-prereq = 12.875x začetnih 8!) + GLASS ENGRAVING+ + MILLING+ + GARDEN+ 2 + ANVIL+ + ARMOR/WEAPON+ + MINING+ + CLOCKMAKING+ + KITCHEN+ + DYE/PIGMENT+ + MASONRY+ + BREWING/BAKING+ + FISHING+ + CANDLE/WAX+ + MUSICAL INSTRUMENTS+ + POTTERY+ + TEXTILE+ + BOOKBINDING+ + FOUNDRY+ + GLASSMAKING+ + ASTRONOMY+ + SURGICAL+ + TECH TREE IV + HOVER TOOLTIP EKOSISTEM + CUSTOM PRESET CRUD + MULTI-SELECT PERSISTENCE + CONFIG PRESETS + EXPORT/IMPORT + 100% mouse/wheel + overlay + DynamicMarket + Save/Load + 7 grafov
