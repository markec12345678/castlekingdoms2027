...
if love.graphics.getHeight() >= 1440 and love.graphics.getWidth() >= 2560 and love.graphics.getWidth() < 3840 then
    ...
    loveframes.font_times_new_medium = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 21)
    loveframes.font_times_new_normal_large = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 24)
    loveframes.font_times_new_normal_large_48 = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 36)
...
elseif love.graphics.getHeight() >= 1440 and love.graphics.getWidth() >= 3840 then
    ...
    loveframes.font_times_new_medium = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 32)
    loveframes.font_times_new_normal_large = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 36)
    loveframes.font_times_new_normal_large_48 = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 48)
...
elseif love.graphics.getHeight() <= 720 and love.graphics.getWidth() <= 1280 then
    ...
    loveframes.font_times_new_medium = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 13)
    loveframes.font_times_new_normal_large = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 16)
    loveframes.font_times_new_normal_large_48 = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 22)
    ...
    loveframes.font_times_new_medium = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 15)
    loveframes.font_times_new_normal_large = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 18)
    loveframes.font_times_new_normal_large_48 = love.graphics.newFont("assets/fonts/TimesNewNormal.ttf", 24)
