local patchy = require("libraries.patchy.patchy")
...
return function(loveframes)
    ...
    skin.name = "StoneKingdoms"
    skin.author = "boskee"
    skin.version = "0.1"

    local color = function(s, a)
        return { loveframes.Color(s, a) }
    end
...
--]]
    ...
    function skin.button(object)
        ...
        local font = height < 50 and loveframes.font_times_new_normal_large or loveframes.font_times_new_normal_large_48
        ...
        if object.toggleable then
            ...
            local cx, cy, cw, ch = bg:draw(x, y, width, height)
            -- button text
...
--]]
    ---------------------------------------------------------
    local tooltip_border = love.graphics.newImage('assets/ui/tooltip_border.png')
    function skin.tooltip(object)
        ...
        love.graphics.rectangle("line", x - 1, y - 1, width + 2, height + 2)
        love.graphics.setColor(29 / 255, 24 / 255, 22 / 255)
        love.graphics.rectangle("line", x + 1, y + 1, width - 2, height - 2)
        love.graphics.setColor(36 / 255, 30 / 255, 27 / 255)
        love.graphics.rectangle("line", x + 2, y + 2, width - 4, height - 4)
        love.graphics.setColor(7 / 255, 7 / 255, 6 / 255, 162 / 255)
        love.graphics.rectangle("line", x - 2, y - 2, width + 4, height + 4)
        love.graphics.setColor(7 / 255, 7 / 255, 6 / 255, 98 / 255)
        love.graphics.rectangle("line", x - 3, y - 3, width + 6, height + 6)
        love.graphics.setColor(7 / 255, 7 / 255, 6 / 255, 49 / 255)
        love.graphics.rectangle("line", x - 4, y - 4, width + 8, height + 8)
        love.graphics.setColor(1, 1, 1, 1)
        love.graphics.draw(tooltip_border, x - 9, y + height - 19)
    end
