...
local PERSONALITIES = {
    ...
    siege_master = {
        ...
        defensePriority = 0.6,
        preferredUnits = {"Engineer", "NormanKnight", "Crossbowman"},
        preferredBuildings = {"EngineersGuild", "StoneBarracks", "SquareTower", "TournamentArena"},
    ...
    fortress_keeper = {
        ...
        preferredUnits = {"Huscarl", "Pikeman", "Crossbowman", "Longbowman"},
        preferredBuildings = {"SquareTower", "RoundTower", "StoneGateSouth", "WoodenWall", "StoneBarracks", "WatchTower"},
    ...
    raider = {
        ...
        defensePriority = 0.3,
        preferredUnits = {"Maceman", "Javelinman", "Archer", "NormanKnight"},
    ...
    diplomat = {
        ...
        defensePriority = 0.7,
        preferredUnits = {"Knight", "Crossbowman", "Spearman", "Longbowman"},
        preferredBuildings = {"Market", "Barracks", "SquareTower", "Inn", "Shrine"},
