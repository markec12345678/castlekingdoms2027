...
local directionalAnimations = {
    ["body_crossbowman_attack_1"] = { ["end"] = 16 },
    ["body_crossbowman_attack_2"] = { ["end"] = 20 },
    ["body_crossbowman_idle"] = { ["end"] = 24 },
    ["body_crossbowman_idle_stand"] = { ["end"] = 16, ["start"] = 16, ["indexQuadsName"] = "body_crossbowman_walk" },
    ["body_crossbowman_walk"] = { ["end"] = 16 },
    ["body_crossbowman_walk_sword"] = { ["end"] = 16 },
}
...
animations["body_crossbowman_die"] = _G.indexQuads("body_crossbowman_die", 28)
return animations
