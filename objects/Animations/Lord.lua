...
local directionalAnimations = {
    ["body_lord_attack_1"] = {["end"]=16},
    ["body_lord_attack_2"] = {["end"]=20},
    ["body_lord_idle"] = {["end"]=24},
    ["body_lord_idle_stand"] = {["end"]=16, ["start"]=16, ["indexQuadsName"]="body_lord_walk"},
    ["body_lord_walk"] = {["end"]=16},
    ["body_lord_walk_sword"] = {["end"]=16},
}
...
animations["body_lord_die"] = _G.indexQuads("body_lord_die", 28)
return animations
