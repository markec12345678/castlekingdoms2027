...
local fr_idling_east_1 = { tq["body_peasant_idle_ne (1)"], tq["body_peasant_idle_sw (1)"],

    tq["body_peasant_idle_ne (2)"], tq["body_peasant_idle_sw (2)"],

    tq["body_peasant_idle_ne (3)"], tq["body_peasant_idle_sw (3)"],

    tq["body_peasant_idle_ne (4)"], tq["body_peasant_idle_sw (4)"],

    tq["body_peasant_idle_ne (5)"], tq["body_peasant_idle_sw (5)"],

    tq["body_peasant_idle_ne (6)"], tq["body_peasant_idle_sw (6)"] }
fr_idling_east_1 = _G.addReverse(fr_idling_east_1)
local fr_idling_north_1 = { tq["body_peasant_idle_n (1)"], tq["body_peasant_idle_s (1)"],

    tq["body_peasant_idle_n (2)"], tq["body_peasant_idle_s (2)"],

    tq["body_peasant_idle_n (3)"], tq["body_peasant_idle_s (3)"],

    tq["body_peasant_idle_n (4)"], tq["body_peasant_idle_s (4)"],

    tq["body_peasant_idle_n (5)"], tq["body_peasant_idle_s (5)"],

    tq["body_peasant_idle_n (6)"], tq["body_peasant_idle_s (6)"] }
fr_idling_north_1 = _G.addReverse(fr_idling_north_1)
local fr_idling_south_1 = { tq["body_peasant_idle_e (1)"], tq["body_peasant_idle_w (1)"],

    tq["body_peasant_idle_e (2)"], tq["body_peasant_idle_w (2)"],

    tq["body_peasant_idle_e (3)"], tq["body_peasant_idle_w (3)"],

    tq["body_peasant_idle_e (4)"], tq["body_peasant_idle_w (4)"],

    tq["body_peasant_idle_e (5)"], tq["body_peasant_idle_w (5)"],

    tq["body_peasant_idle_e (6)"], tq["body_peasant_idle_w (6)"] }
fr_idling_south_1 = _G.addReverse(fr_idling_south_1)
local fr_idling_west_1 = { tq["body_peasant_idle_se (1)"], tq["body_peasant_idle_nw (1)"],

    tq["body_peasant_idle_se (2)"], tq["body_peasant_idle_nw (2)"],

    tq["body_peasant_idle_se (3)"], tq["body_peasant_idle_nw (3)"],

    tq["body_peasant_idle_se (4)"], tq["body_peasant_idle_nw (4)"],

    tq["body_peasant_idle_se (5)"], tq["body_peasant_idle_nw (5)"],

    tq["body_peasant_idle_se (6)"], tq["body_peasant_idle_nw (6)"] }
