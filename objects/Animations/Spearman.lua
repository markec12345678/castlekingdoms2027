...
local directionalAnimations = {
    ["spearman_attack_1"] = { ["end"] = 16 },
    ["spearman_attack_2"] = { ["end"] = 20 },
    ["spearman_idle"] = { ["end"] = 24 },
    ["spearman_idle_stand"] = { ["end"] = 16, ["start"] = 16, ["indexQuadsName"] = "spearman_walk" },
    ["spearman_walk"] = { ["end"] = 16 },
    ["spearman_walk_sword"] = { ["end"] = 16 },
}
...
animations["spearman_die"] = _G.indexQuads("spearman_die", 28)
return animations
