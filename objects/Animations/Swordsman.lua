...
local directionalAnimations = {
    ["body_swordsman_attack_1"] = { ["end"] = 16 },
    ["body_swordsman_attack_2"] = { ["end"] = 20 },
    ["body_swordsman_idle"] = { ["end"] = 24 },
    ["body_swordsman_idle_stand"] = { ["end"] = 16, ["start"] = 16, ["indexQuadsName"] = "body_swordsman_walk" },
    ["body_swordsman_walk"] = { ["end"] = 16 },
    ["body_swordsman_walk_sword"] = { ["end"] = 16 },
}
...
animations["body_swordsman_die"] = _G.indexQuads("body_swordsman_die", 28)
return animations
