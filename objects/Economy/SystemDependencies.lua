...
local dependencyGraph = {
    ...
    -- v3.12.058: Abacus–Aqueduct singles (6 multi, 56th)
    AbacusMaker              = {"WoodLathe", "Metalwork"},               -- multi! wooden frame + metal rods
    AloeCultivator           = {"WoodLathe", "PotteryWheel"},            -- multi! CROSS-CHAIN: wooden beds + pottery pots → Lončarstvo+
    AngelusBellMaker         = {"Metalwork", "WoodLathe"},               -- multi! metal bell + wooden yoke
    AnvilStumpMaker          = {"WoodLathe", "Metalwork"},               -- multi! wooden stump + metal bands
    AquariumKeeper           = {"GlassBench", "WoodLathe"},              -- multi! CROSS-CHAIN: glass tank + wooden stand → Steklarstvo+
    AqueductMaker            = {"MasonStonecutter", "Metalwork"},        -- multi! CROSS-CHAIN: stone channel + metal gates → Kamnoseštvo+

    -- v3.12.059: Arbalest–BakingSheet (6 multi, 57th)
    ArbalestMaker            = {"Metalwork", "WoodLathe"},               -- multi! metal prod + wooden stock
    AugerBitMaker            = {"Metalwork", "WoodLathe"},               -- multi! metal bit + wooden handle
    AviaryKeeper             = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden cages + netting → Tekstil+
    BackgammonMaker          = {"WoodLathe", "Metalwork"},               -- multi! wooden board + metal hinges
    Baker                    = {"WoodLathe", "Metalwork"},               -- multi! wooden peels + metal ovens
    BakingSheetMaker         = {"Metalwork", "WoodLathe"},               -- multi! metal sheet + wooden forms

    -- v3.12.060: Balance–Beaker (6 multi, 58th)
    BalanceScaleMaker        = {"Metalwork", "WoodLathe"},               -- multi! metal arms + wooden base
    BarometerMaker           = {"GlassBench", "Metalwork"},              -- multi! CROSS-CHAIN: glass tube + metal case → Steklarstvo+
    BasketWeaver             = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden form + cord → Tekstil+
    BattlementMaker          = {"MasonStonecutter", "Metalwork"},        -- multi! CROSS-CHAIN: stone crenels + metal anchors → Kamnoseštvo+
    BeaconLightMaker         = {"Metalwork", "GlassBench"},              -- multi! CROSS-CHAIN: metal beacon + glass lens → Steklarstvo+
    BeakerBlower             = {"GlassBench", "Metalwork"},              -- multi! CROSS-CHAIN: glass beaker + metal tools → Steklarstvo+

    -- v3.12.061: BeardComb–Billiard (6 multi, 59th)
    BeardCombMaker           = {"WoodLathe", "Metalwork"},               -- multi! wooden comb + metal teeth
    BedMaker                 = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden frame + bedding → Tekstil+
    Beekeeper                = {"WoodLathe", "Metalwork"},               -- multi! wooden hive + metal tools
    BellowsMaker             = {"RawhideTanner", "WoodLathe"},           -- multi! CROSS-CHAIN: leather bellows + wooden arms → Usnjarstvo+
    BickHornAnvilMaker       = {"Metalwork", "WoodLathe"},               -- multi! metal horn + wooden base
    BilliardMaker            = {"WoodLathe", "Metalwork"},               -- multi! wooden table + metal cushions

    -- v3.12.062: Binding–Bran (6 multi, 60th)
    BindingCordMaker         = {"SpinningWheel", "WoodLathe"},           -- multi! CROSS-CHAIN: cord + wooden spool → Tekstil+
    BisqueStandMaker         = {"PotteryWheel", "WoodLathe"},            -- multi! CROSS-CHAIN: pottery stand + wooden base → Lončarstvo+
    BobbinWinderMaker        = {"WoodLathe", "Metalwork"},               -- multi! wooden winder + metal spindle
    BoltLatchMaker           = {"Metalwork", "WoodLathe"},               -- multi! metal latch + wooden mount
    BottomFullerMaker        = {"Metalwork", "WoodLathe"},               -- multi! metal fuller + wooden haft
    BranSeparatorMaker       = {"Metalwork", "WoodLathe"},               -- multi! metal sieve + wooden frame

    -- v3.12.063: Bread–Butterfly (6 multi, 61st)
    BreadLameMaker           = {"Metalwork", "WoodLathe"},               -- multi! metal blade + wooden handle
    Distiller                = {"Metalwork", "GlassBench"},              -- multi! CROSS-CHAIN: metal still + glass condenser → Steklarstvo+
    BridgeMaker              = {"WoodLathe", "Metalwork"},               -- multi! wooden deck + metal fittings
    BroochMaker              = {"Metalwork", "WoodLathe"},               -- multi! metal brooch + wooden forms
    BulbPlanterMaker         = {"Metalwork", "WoodLathe"},               -- multi! metal planter + wooden handle
    ButterflyBreeder         = {"WoodLathe", "GlassBench"},              -- multi! CROSS-CHAIN: wooden cages + glass → Steklarstvo+

    -- v3.12.064: Button–CardDeck (6 multi, 62nd)
    ButtonMaker              = {"Metalwork", "WoodLathe"},               -- multi! metal dies + wooden press
    CabinetMaker             = {"WoodLathe", "Metalwork"},               -- multi! wooden cabinet + metal hinges
    CalendarMaker            = {"WoodLathe", "Metalwork"},               -- multi! wooden calendar + metal pins
    CandlestickBaseMaker     = {"Metalwork", "WoodLathe"},               -- multi! metal base + wooden lathe work
    CanvasStretcherMaker     = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden frame + canvas → Tekstil+
    CardDeckMaker            = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden press + paper/cloth → Tekstil+

    -- v3.12.065: Carillon–Chain (6 multi, 63rd)
    CarillonMaker            = {"Metalwork", "WoodLathe"},               -- multi! metal bells + wooden frame
    CattleRancher            = {"WoodLathe", "RawhideTanner"},           -- multi! CROSS-CHAIN: wooden pens + leather → Usnjarstvo+
    CelestialGlobeMaker      = {"Metalwork", "WoodLathe"},               -- multi! metal globe + wooden stand
    CentrifugalCasterMaker   = {"Metalwork", "WoodLathe"},               -- multi! metal caster + wooden drive
    CeremonialSashMaker      = {"SpinningWheel", "Metalwork"},           -- multi! CROSS-CHAIN: cloth sash + metal clasps → Tekstil+
    ChainMaker               = {"Metalwork", "WoodLathe"},               -- multi! metal links + wooden forms

    -- v3.12.066: Chair–CiderPress (6 multi, 64th)
    ChairMaker               = {"WoodLathe", "Metalwork"},               -- multi! wooden chair + metal fittings
    Chandlery                = {"Metalwork", "WoodLathe"},               -- multi! metal molds + wooden workbench
    ChestMaker               = {"WoodLathe", "Metalwork"},               -- multi! wooden chest + metal bands
    ChimeHammerMaker         = {"Metalwork", "WoodLathe"},               -- multi! metal hammer + wooden handle
    ChocolateConfectioner    = {"Metalwork", "WoodLathe"},               -- multi! metal molds + wooden tools
    CiderPress               = {"WoodLathe", "Metalwork"},               -- multi! wooden press + metal screw

    -- v3.12.067: Cistern–ColdFrame (6 multi, 65th)
    CisternMaker             = {"MasonStonecutter", "Metalwork"},        -- multi! CROSS-CHAIN: stone cistern + metal pipes → Kamnoseštvo+
    ClampMaker               = {"Metalwork", "WoodLathe"},               -- multi! metal clamp + wooden jaws
    ClayExtruderMaker        = {"Metalwork", "WoodLathe"},               -- multi! metal extruder + wooden frame
    ClockDialEngraverMaker   = {"Metalwork", "WoodLathe"},               -- multi! metal engraver + wooden rest
    CofferMaker              = {"WoodLathe", "Metalwork"},               -- multi! wooden coffer + metal bands
    ColdFrameMaker           = {"WoodLathe", "GlassBench"},              -- multi! CROSS-CHAIN: wooden frame + glass → Steklarstvo+

    -- v3.12.068: Collar–Cookware (6 multi, 66th)
    CollarOfEstate           = {"Metalwork", "SpinningWheel"},           -- multi! CROSS-CHAIN: metal links + cloth → Tekstil+
    CombMaker                = {"WoodLathe", "Metalwork"},               -- multi! wooden comb + metal teeth
    CommemorativeTokenMaker  = {"Metalwork", "WoodLathe"},               -- multi! metal token + wooden dies
    CommendationScroll       = {"SpinningWheel", "WoodLathe"},           -- multi! CROSS-CHAIN: parchment/cloth + wooden rollers → Tekstil+
    Confectioner             = {"Metalwork", "WoodLathe"},               -- multi! metal molds + wooden tools
    CookwareFounder          = {"Metalwork", "WoodLathe"},               -- multi! metal cookware + wooden patterns

    -- v3.12.069: Cooper–CourtFan (6 multi, 67th)
    Cooper                   = {"WoodLathe", "Metalwork"},               -- multi! wooden staves + metal hoops
    CopperSheetMaker         = {"Metalwork", "WoodLathe"},               -- multi! copper sheet + wooden forms
    CordageMaker             = {"SpinningWheel", "WoodLathe"},           -- multi! CROSS-CHAIN: cord + wooden posts → Tekstil+
    CostumeTailor            = {"SpinningWheel", "Metalwork"},           -- multi! CROSS-CHAIN: cloth + metal needles → Tekstil+
    CottonGin                = {"WoodLathe", "Metalwork"},               -- multi! wooden gin + metal rollers
    CourtFanMaker            = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden sticks + cloth → Tekstil+

    -- v3.12.070: Crane–Crystallization (6 multi, 68th)
    CraneMaker               = {"Metalwork", "WoodLathe"},               -- multi! metal crane + wooden boom
    Crocheter                = {"SpinningWheel", "WoodLathe"},           -- multi! CROSS-CHAIN: yarn + wooden hooks → Tekstil+
    CrumbTrayMaker           = {"Metalwork", "WoodLathe"},               -- multi! metal tray + wooden handle
    CrumhornMaker            = {"WoodLathe", "Metalwork"},               -- multi! wooden instrument + metal reed
    CrustScorerMaker         = {"Metalwork", "WoodLathe"},               -- multi! metal scorer + wooden handle
    CrystallizationDishMaker = {"GlassBench", "Metalwork"},              -- multi! CROSS-CHAIN: glass dish + metal stand → Steklarstvo+

    -- v3.12.071: Cupola–Degassing (6 multi, 69th)
    CupolaTuyereMaker        = {"Metalwork", "MasonStonecutter"},        -- multi! CROSS-CHAIN: metal tuyere + stone cupola → Kamnoseštvo+
    CurtainMaker             = {"SpinningWheel", "WoodLathe"},           -- multi! CROSS-CHAIN: cloth curtain + wooden rod → Tekstil+
    CushionMaker             = {"SpinningWheel", "RawhideTanner"},       -- multi! CROSS-CHAIN: cloth + leather → Tekstil+ & Usnjarstvo+
    CutterHardyMaker         = {"Metalwork", "WoodLathe"},               -- multi! metal hardy + wooden block
    CuttingBoardMaker        = {"WoodLathe", "Metalwork"},               -- multi! wooden board + metal feet
    DegassingLanceMaker      = {"Metalwork", "WoodLathe"},               -- multi! metal lance + wooden handle

    -- v3.12.072: Dibber–DyeStuff (6 multi, 70th)
    DibberMaker              = {"WoodLathe", "Metalwork"},               -- multi! wooden dibber + metal tip
    DollHouseMaker           = {"WoodLathe", "Metalwork"},               -- multi! wooden house + metal fittings
    DominoMaker              = {"WoodLathe", "Metalwork"},               -- multi! wooden tiles + metal press
    DrawbridgeMaker          = {"WoodLathe", "Metalwork"},               -- multi! wooden bridge + metal chains
    DrummerMaker             = {"WoodLathe", "RawhideTanner"},           -- multi! CROSS-CHAIN: wooden drum + leather skin → Usnjarstvo+
    DyeStuffMaker            = {"PigmentGrinderMaker", "WoodLathe"},     -- multi! CROSS-CHAIN: pigments + wooden vats → Barvila+

    -- v3.12.073: Dyer–Filtration (6 multi, 71st)
    Dyer                     = {"PigmentGrinderMaker", "SpinningWheel"}, -- multi! CROSS-CHAIN: dyes + cloth → Barvila+ & Tekstil+
    EggCupMaker              = {"PotteryWheel", "WoodLathe"},            -- multi! CROSS-CHAIN: pottery cup + wooden base → Lončarstvo+
    EngravingMachineMaker    = {"Metalwork", "WoodLathe"},               -- multi! metal engraver + wooden table
    EvaporatingBasinMaker    = {"Metalwork", "GlassBench"},              -- multi! CROSS-CHAIN: metal basin + glass → Steklarstvo+
    FiddleMaker              = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden body + strings → Tekstil+
    FiltrationApparatusMaker = {"GlassBench", "Metalwork"},              -- multi! CROSS-CHAIN: glass filter + metal stand → Steklarstvo+

    -- v3.12.074: Fish–Fuller (6 multi, 72nd)
    FishScalerMaker          = {"Metalwork", "WoodLathe"},               -- multi! metal scaler + wooden handle
    Fisherman                = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden rods + nets → Tekstil+
    FishingNetMaker          = {"SpinningWheel", "WoodLathe"},           -- multi! CROSS-CHAIN: net cord + wooden needle → Tekstil+
    FlaskMaker               = {"GlassBench", "Metalwork"},              -- multi! CROSS-CHAIN: glass flask + metal stand → Steklarstvo+
    FlatterMaker             = {"Metalwork", "WoodLathe"},               -- multi! metal flatter + wooden handle
    FullerMaker              = {"Metalwork", "WoodLathe"},               -- multi! metal fuller + wooden haft

    -- v3.12.075: Funnel–Greave (6 multi, 73rd)
    FunnelMaker              = {"Metalwork", "WoodLathe"},               -- multi! metal funnel + wooden handle
    Furrier                  = {"RawhideTanner", "Metalwork"},           -- multi! CROSS-CHAIN: fur/leather + metal tools → Usnjarstvo+
    GildingPressMaker        = {"Metalwork", "WoodLathe"},               -- multi! metal press + wooden frame
    Glassmaker               = {"GlassBench", "Metalwork"},              -- multi! CROSS-CHAIN: glass + metal tools → Steklarstvo+
    GlockenspielMaker        = {"Metalwork", "WoodLathe"},               -- multi! metal bars + wooden frame
    GreaveArmorer            = {"Metalwork", "RawhideTanner"},           -- multi! CROSS-CHAIN: metal greaves + leather straps → Usnjarstvo+

    -- v3.12.076: Hairbrush–Harpoon (6 multi, 74th)
    HairbrushMaker           = {"WoodLathe", "Metalwork"},               -- multi! wooden brush + metal ferrule
    HairpinMaker             = {"Metalwork", "WoodLathe"},               -- multi! metal pin + wooden forms
    HammerMaker              = {"Metalwork", "WoodLathe"},               -- multi! metal head + wooden handle
    HandTrowelMaker          = {"Metalwork", "WoodLathe"},               -- multi! metal blade + wooden handle
    HandbellMaker            = {"Metalwork", "WoodLathe"},               -- multi! metal bell + wooden handle
    HarpoonMaker             = {"Metalwork", "WoodLathe"},               -- multi! metal tip + wooden shaft

    -- v3.12.077: Harrow–Hinge (6 multi, 75th)
    HarrowMaker              = {"Metalwork", "WoodLathe"},               -- multi! metal teeth + wooden frame
    HeadbandLoomMaker        = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden loom + thread → Tekstil+
    HedgeHookMaker           = {"Metalwork", "WoodLathe"},               -- multi! metal hook + wooden handle
    HelmetCrestMaker         = {"Metalwork", "WoodLathe"},               -- multi! metal crest + wooden forms
    HempRetter               = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden retting + fiber → Tekstil+
    HingeMaker               = {"Metalwork", "WoodLathe"},               -- multi! metal hinge + wooden forms

    -- v3.12.078: Hook–Hydrometer (6 multi, 76th)
    HookMaker                = {"Metalwork", "WoodLathe"},               -- multi! metal hook + wooden handle
    HopsGrower               = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden poles + trellis cord → Tekstil+
    HotCutHardyMaker         = {"Metalwork", "WoodLathe"},               -- multi! metal hardy + wooden block
    HuntingTrapMaker         = {"Metalwork", "WoodLathe"},               -- multi! metal trap + wooden trigger
    HurdyGurdyMaker          = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden body + strings → Tekstil+
    HydrometerMaker          = {"GlassBench", "Metalwork"},              -- multi! CROSS-CHAIN: glass tube + metal weight → Steklarstvo+

    -- v3.12.079: Ice–Jigsaw (6 multi, 77th)
    IceCutter                = {"Metalwork", "WoodLathe"},               -- multi! metal saw + wooden handle
    IncenseMolderMaker       = {"Metalwork", "WoodLathe"},               -- multi! metal mold + wooden press
    InkMaker                 = {"PigmentGrinderMaker", "GlassBench"},    -- multi! CROSS-CHAIN: pigments + glass vials → Barvila+ & Steklarstvo+
    InoculationLadleMaker    = {"Metalwork", "WoodLathe"},               -- multi! metal ladle + wooden handle
    Jeweler                  = {"Metalwork", "WoodLathe"},               -- multi! metal tools + wooden bench
    JigsawPuzzleMaker        = {"WoodLathe", "Metalwork"},               -- multi! wooden puzzle + metal saw

    -- v3.12.080: Key–Lace (6 multi, 78th)
    KeyMaker                 = {"Metalwork", "WoodLathe"},               -- multi! metal key + wooden forms
    KitchenScaleMaker        = {"Metalwork", "WoodLathe"},               -- multi! metal scale + wooden base
    KiteMaker                = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden frame + cloth → Tekstil+
    Knitter                  = {"SpinningWheel", "WoodLathe"},           -- multi! CROSS-CHAIN: yarn + wooden needles → Tekstil+
    KnotBoardMaker           = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden board + rope samples → Tekstil+
    LaceMaker                = {"SpinningWheel", "WoodLathe"},           -- multi! CROSS-CHAIN: lace thread + wooden bobbins → Tekstil+

    -- v3.12.081: Ladle–LiceComb (6 multi, 79th)
    LadlePreheaterMaker      = {"Metalwork", "WoodLathe"},               -- multi! metal preheater + wooden handle
    LanternMaker             = {"Metalwork", "GlassBench"},              -- multi! CROSS-CHAIN: metal lantern + glass → Steklarstvo+
    LatrineBuilder           = {"WoodLathe", "MasonStonecutter"},        -- multi! CROSS-CHAIN: wooden structure + stone → Kamnoseštvo+
    LensGrinder              = {"GlassBench", "Metalwork"},              -- multi! CROSS-CHAIN: glass lens + metal tools → Steklarstvo+
    LibraryCatalogMaker      = {"WoodLathe", "Metalwork"},               -- multi! wooden cabinets + metal fittings
    LiceCombMaker            = {"WoodLathe", "Metalwork"},               -- multi! wooden comb + metal teeth

    -- v3.12.082: Linen–Mat (6 multi, 80th)
    LinenRetter              = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden retting + fiber → Tekstil+
    LoafPanMaker             = {"Metalwork", "WoodLathe"},               -- multi! metal pan + wooden forms
    LocketMaker              = {"Metalwork", "WoodLathe"},               -- multi! metal locket + wooden forms
    LyreMaker                = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden body + strings → Tekstil+
    MandolinMaker            = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden body + strings → Tekstil+
    MatMaker                 = {"SpinningWheel", "WoodLathe"},           -- multi! CROSS-CHAIN: woven mat + wooden loom → Tekstil+

    -- v3.12.083: MatchCord–MiningChisel (6 multi, 81st)
    MatchCordMaker           = {"SpinningWheel", "Metalwork"},           -- multi! CROSS-CHAIN: cord + metal tools → Tekstil+
    MeadMaker                = {"WoodLathe", "GlassBench"},              -- multi! CROSS-CHAIN: wooden vats + glass bottles → Steklarstvo+
    MedalMinter              = {"Metalwork", "WoodLathe"},               -- multi! metal dies + wooden press
    MetalMeshMaker           = {"Metalwork", "WoodLathe"},               -- multi! metal mesh + wooden frame
    MicroscopeMaker          = {"GlassBench", "Metalwork"},              -- multi! CROSS-CHAIN: glass lenses + metal body → Steklarstvo+
    MiningChiselMaker        = {"Metalwork", "WoodLathe"},               -- multi! metal chisel + wooden handle

    -- v3.12.084: Mint–Needle (6 multi, 82nd)
    Mint                     = {"Metalwork", "WoodLathe"},               -- multi! metal mint + wooden forms
    MortarPestleStandMaker   = {"WoodLathe", "MasonStonecutter"},        -- multi! CROSS-CHAIN: wooden stand + stone mortar → Kamnoseštvo+
    MushroomForager          = {"WoodLathe", "Metalwork"},               -- multi! wooden baskets + metal tools
    NailMaker                = {"Metalwork", "WoodLathe"},               -- multi! metal nails + wooden forms
    NeedleMaker              = {"Metalwork", "WoodLathe"},               -- multi! metal needles + wooden case
    OlivePressMaker          = {"WoodLathe", "Metalwork"},               -- multi! wooden press + metal screw

    -- v3.12.085: Orchardist–PanFlute (6 multi, 83rd)
    Orchardist               = {"WoodLathe", "Metalwork"},               -- multi! wooden ladders + metal tools
    OrderInsignia            = {"Metalwork", "SpinningWheel"},           -- multi! CROSS-CHAIN: metal badge + cloth → Tekstil+
    OvenPeelMaker            = {"WoodLathe", "Metalwork"},               -- multi! wooden peel + metal tip
    OysterFarmer             = {"WoodLathe", "Metalwork"},               -- multi! wooden cages + metal tools
    PaletteMaker             = {"WoodLathe", "Metalwork"},               -- multi! wooden palette + metal fittings
    PanFluteMaker            = {"WoodLathe", "Metalwork"},               -- multi! wooden pipes + metal bands

    -- v3.12.086: ParadeMace–Pendant (6 multi, 84th)
    ParadeMaceMaker          = {"Metalwork", "WoodLathe"},               -- multi! metal mace + wooden shaft
    ParquetFloorMaker        = {"WoodLathe", "Metalwork"},               -- multi! wooden parquet + metal tools
    PenRestMaker             = {"WoodLathe", "Metalwork"},               -- multi! wooden rest + metal fittings
    PendantMaker             = {"Metalwork", "WoodLathe"},               -- multi! metal pendant + wooden forms
    PerfumeBottleMaker       = {"GlassBench", "Metalwork"},              -- multi! CROSS-CHAIN: glass bottle + metal cap → Steklarstvo+
    Perfumer                 = {"GlassBench", "PigmentGrinderMaker"},    -- multi! CROSS-CHAIN: glass + essences → Steklarstvo+ & Barvila+

    -- v3.12.087: Physic–PlaneIron (6 multi, 85th)
    PhysicPotionMaker        = {"GlassBench", "PigmentGrinderMaker"},    -- multi! CROSS-CHAIN: glass vials + ingredients → Steklarstvo+ & Barvila+
    PickleCurer              = {"WoodLathe", "PotteryWheel"},            -- multi! CROSS-CHAIN: wooden barrels + pottery jars → Lončarstvo+
    PigFarmer                = {"WoodLathe", "Metalwork"},               -- multi! wooden pens + metal tools
    PipeTaborMaker           = {"WoodLathe", "Metalwork"},               -- multi! wooden pipe + metal fittings
    PitchforkMaker           = {"Metalwork", "WoodLathe"},               -- multi! metal tines + wooden handle
    PlaneIronMaker           = {"Metalwork", "WoodLathe"},               -- multi! metal iron + wooden plane body

    -- v3.12.088: Planer–Polisher (6 multi, 86th)
    PlanerMaker              = {"Metalwork", "WoodLathe"},               -- multi! metal blades + wooden body
    PlanetariumMaker         = {"Metalwork", "WoodLathe"},               -- multi! metal spheres + wooden stand
    PlayingCardMaker         = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden press + paper/cloth → Tekstil+
    PlowMaker                = {"Metalwork", "WoodLathe"},               -- multi! metal share + wooden beam
    PolisherMaker            = {"Metalwork", "WoodLathe"},               -- multi! metal polisher + wooden handle
    PortcullisMaker          = {"Metalwork", "WoodLathe"},               -- multi! metal grate + wooden guides

    -- v3.12.089: Potpourri–PotteryWheel (6 multi, 87th)
    PotpourriBowlMaker       = {"PotteryWheel", "WoodLathe"},            -- multi! CROSS-CHAIN: pottery bowl + wooden lid → Lončarstvo+
    Potter                   = {"PotteryWheel", "WoodLathe"},            -- multi! CROSS-CHAIN: wheel + wooden tools → Lončarstvo+
    PotteryWheelMaker        = {"WoodLathe", "Metalwork"},               -- multi! wooden wheel + metal axle
    PoultryKeeper            = {"WoodLathe", "Metalwork"},               -- multi! wooden coops + metal feeders
    PrintingPressMaker       = {"WoodLathe", "Metalwork"},               -- multi! wooden press + metal type
    PritchelHoleMaker        = {"Metalwork", "WoodLathe"},               -- multi! metal pritchel + wooden block

    -- v3.12.090: Processional–Quarry (6 multi, 88th)
    ProcessionalCanopyMaker  = {"SpinningWheel", "WoodLathe"},           -- multi! CROSS-CHAIN: cloth canopy + wooden poles → Tekstil+
    ProofingBasketMaker      = {"WoodLathe", "SpinningWheel"},           -- multi! CROSS-CHAIN: wooden/wicker + cloth liner → Tekstil+
    ProspectingPanMaker      = {"Metalwork", "WoodLathe"},               -- multi! metal pan + wooden handle
