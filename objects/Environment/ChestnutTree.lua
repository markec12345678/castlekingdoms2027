...
local an = {
    ...
    [ANIM_MEDIUM_STATIC] = _G.indexQuads("tree_chestnut_medium", 25, nil, true),
    [ANIM_MEDIUM_FALLING] = _G.indexQuads("tree_chestnut_medium_falling", 8),
    [ANIM_MEDIUM_CHOP] = _G.indexQuads("tree_chestnut_medium_falling", 12, 8),
    [ANIM_SMALL_STATIC] = _G.indexQuads("tree_chestnut_small", 25, nil, true),
    [ANIM_SMALL_FALLING] = _G.indexQuads("tree_chestnut_small_falling", 8),
    [ANIM_SMALL_CHOP] = _G.indexQuads("tree_chestnut_small_falling", 10, 8),
    [ANIM_VERY_SMALL_STATIC] = _G.indexQuads("tree_chestnut_very_small", 25, nil, true),
    [ANIM_VERY_SMALL_FALLING] = _G.indexQuads("tree_chestnut_very_small_falling", 5),
    [ANIM_VERY_SMALL_CHOP] = _G.indexQuads("tree_chestnut_very_small_falling", 7, 6)
}

local Chestnut = _G.class("ChestnutTree", Tree)
function Chestnut:initialize(gx, gy, type)
    type = type or "Chestnut tree"
    ...
    elseif type == "Small chestnut tree" then
        self.health = 5
    ...
    elseif type == "Very small chestnut tree" then
        self.health = 3
        self.cuttable = false
...
function Chestnut.static:deserialize(data)
