...
local Granary = class('Granary', Object)
			function Granary:initialize(cx,cy,i,o,x,y,type)
				...
				-- self.stockpile[2].id = Granary_alias:new(tile_quads[0],self.gx+1,self.gy+4,self,32-4,-16)
				-- self.stockpile[3].id = Granary_alias:new(tile_quads[0],self.gx+4,self.gy+1,self,32-4,-16)
				-- self.stockpile[4].id = Granary_alias:new(tile_quads[0],self.gx+4,self.gy+4,self,32-4,-16)
