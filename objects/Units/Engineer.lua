...
local an = require("objects.Animations.Engineer")

local Engineer = _G.class("Engineer", Soldier)
...
function Engineer:dirSubUpdate()
    local walkAnimationName = "body_siege_engineer_walk"
    self.animation = self:getDirectionalAnimation(an, walkAnimationName, 0.08, nil, self.moveDir)
end

function Engineer:serialize()
    local data = {}
