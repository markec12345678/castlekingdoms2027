				...
				elseif self.state ~= "No path to farm" then
					...
					elseif self.state == "Go to foodpile" then
						if _G.foodpile then
							...
							if not closest_node then print("Closest foodpile node not found") else                                    
					...
					if self.state == "Going to workplace" or self.state == "Going to foodpile" or self.state == "Going to apple tree" then
						self:move()
					end
