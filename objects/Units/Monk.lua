...
local an = require("objects.Animations.Monk")

local Monk = _G.class("Monk", Soldier)
...
function Monk:dirSubUpdate()
    local walkAnimationName = "body_fighting_monk_run"
    self.animation = self:getDirectionalAnimation(an, walkAnimationName, 0.08, nil, self.moveDir)
end

function Monk:serialize()
    local data = {}
