...
local an = require("objects.Animations.Pikeman")
...
function Pikeman:dirSubUpdate()
    local walkAnimationName = "pikemen_walk"
    self.animation = self:getDirectionalAnimation(an, walkAnimationName, 0.08, nil, self.moveDir)
end

function Pikeman:serialize()
    local data = {}
