...
-- Castle Kingdoms 2027 v3.12.132: Tutorial Manager Panel (Ctrl+Shift+O)
local TutorialPanel = require("states.ui.hud.tutorial_panel")
...
local function delayedInit()
    ...
    -- v3.12.212: HD Building Sprite Override System
...
function game:draw()
    if not _G.testMode then
        if _G.loaded then
            ...
            -- Castle Kingdoms 2027 v3.12.132: Draw Tutorial Manager Panel (Ctrl+Shift+O)
            TutorialPanel.draw()
...
function game:mousepressed(x, y, button, istouch)
    ...
    -- Castle Kingdoms 2027 v3.12.128: Achievement panel click handling
    ...
    -- Castle Kingdoms 2027 v3.12.132: Tutorial panel click handling
    if TutorialPanel.isVisible() then
        if TutorialPanel.mousepressed(x, y, button) then return end
    end
...
function game:textinput(text)
    ...
    -- Castle Kingdoms 2027 v3.12.132: Tutorial panel search input
    if TutorialPanel.isVisible() then
...
function game:keypressed(key, scancode, isRepeat)
    ...
    -- Castle Kingdoms 2027 v3.12.128: Forward keys to Achievement Panel if visible
    if AchievementPanel.isVisible() then
    ...
    -- Castle Kingdoms 2027 v3.12.132: Forward keys to Tutorial Panel if visible
    if TutorialPanel.isVisible() then
    ...
    if key == "a" and (love.keyboard.isDown("lctrl") or love.keyboard.isDown("rctrl")) then
        -- v3.12.128: Ctrl+Shift+A = Modern Achievement Panel; Ctrl+A = legacy gallery
    ...
    -- v3.12.132: Ctrl+Shift+O = Toggle Tutorial Manager Panel
    if key == "o" and (love.keyboard.isDown("lctrl") or love.keyboard.isDown("rctrl"))
                  and (love.keyboard.isDown("lshift") or love.keyboard.isDown("rshift")) then
        TutorialPanel.toggle()
        return
    end
    -- v3.12.133: Ctrl+Shift+F = Toggle Difficulty Settings Panel
    if key == "f" and (love.keyboard.isDown("lctrl") or love.keyboard.isDown("rctrl"))
                  and (love.keyboard.isDown("lshift") or love.keyboard.isDown("rshift")) then
...
function game:mousereleased(x, y, button, istouch)
    ...
    -- Castle Kingdoms 2027 v3.11.937: Market Dashboard mousereleased
    if MarketDashboard.isVisible() then
        if MarketDashboard.mousereleased(x, y, button) then return end
    end
...
function game:mousemoved(x, y, dx, dy, istouch)
    ...
    -- Castle Kingdoms 2027 v3.12.128: Achievement panel mousemoved (hover detection)
    if AchievementPanel.isVisible() then
    ...
    -- Castle Kingdoms 2027 v3.12.132: Tutorial panel mousemoved (for future use)
    if TutorialPanel.isVisible() then
    ...
    -- Castle Kingdoms 2027 v3.11.937: Market Dashboard mousemoved
    if MarketDashboard.isVisible() then
        if MarketDashboard.mousemoved(x, y, dx, dy) then return end
    end
...
function game:wheelmoved(x, y)
    ...
    if DifficultyPanel.isVisible() then
        if DifficultyPanel.wheelmoved(x, y) then return end
    end
